...
public class addNewFactory_SIT {
	...
	public static void main (String[] args) {
		System.setProperty("webdriver.chrome.driver", "C:\\temp\\chromedriver.exe");
	 	...
	 	driver.get("https://int-sh-external.someEmailProvider.com");
        ...
        driver.manage().window().setSize(d);
	 	...
	 	wait.until(ExpectedConditions.elementToBeClickable(SelectorExternal.SignIn));
	 			...
	 			//type email 
	 			driver.findElement(SelectorExternal.username).sendKeys("qualitynow2028+suppemail+sit+447@email.com");
