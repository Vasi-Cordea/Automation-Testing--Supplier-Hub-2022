...
public class Onboarding_Externa_UAT {
	public static void main (String args[]) throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\temp\\chromedriver.exe");
	 	...
	 	driver.get("https://uat-sh-external.emailtest.com");
     ...
     // explicit wait - to wait for the Next button to be click-able
        WebDriverWait wait = new WebDriverWait(driver, 10);
 	 	wait.until(ExpectedConditions.elementToBeClickable(SelectorExternal.SignIn));
 	 			...
 	 			//type email 
 	 			driver.findElement(SelectorExternal.username).sendKeys("type in 15sec, don't click Sign In ");
 	 			//driver.findElement(SelectorExternal.passwrord).sendKeys("M80#zOemgf"); 			
...
//          What is the full registered name of the factory?
 	 		   // create instance of Random class
 	 			...
 	 			driver.findElement(SelectorExternal.registered_factory_name).sendKeys(rand_int1+" Testers Factory Selenium");
...
//           Who is your main contact for this factory?
 	 			...
 	 			driver.findElement(SelectorExternal.contact_first_name).sendKeys("Tester");
 	 			
 	 			driver.findElement(SelectorExternal.contact_surname).sendKeys("John");
 	 			
 	 			driver.findElement(SelectorExternal.contact_email).sendKeys("qualitynow2024+factoryEmail+uat"+rand_int1+"@emailtest.com");
...
//               Who is responsible for product compliance at this factory?
  					...
  					driver.findElement(SelectorExternal.product_compliance_contact_first_name).sendKeys("Jefe");
  					driver.findElement(SelectorExternal.product_compliance_contact_surname).sendKeys("BOSS Surname");
  					
  					driver.findElement(SelectorExternal.product_compliance_contact_email).sendKeys("qualitynow2024+productBoss+uat"+rand_int1+"@emailtest.com");
...
// 			 What is the factory address?					
  					...
  					driver.findElement(SelectorExternal.factory_head_count).sendKeys("160");
...
//         Capability and Capacity Information
    				...
    				driver.findElement(SelectorExternal.z_someEmailProvider_capacity).sendKeys(rand_int4+"4");
     	 ...
     	 //eDIT Financial iNFORMATION
     			...
     			wait.until(ExpectedConditions.elementToBeClickable(SelectorExternal.financialInfoEdit));
 		 		...
 		 		// Generate random integers in range 0 to 999
 					...
 					driver.findElement(SelectorExternal.branch_address_county).sendKeys("County NR34");
 					...
 					int rand_int44 = rand.nextInt(100);
 					driver.findElement(SelectorExternal.branch_address_postcode).sendKeys("456564"+rand_int44);
 					
 			
 					
 					int rand_int41 = rand.nextInt(10);
 					driver.findElement(SelectorExternal.bic_swift_code).sendKeys(rand_int41+"0000000512");
 					
 					int rand_int32 = rand.nextInt(10);
 					driver.findElement(SelectorExternal.bank_account_number).sendKeys("0000023"+rand_int32);
					...
					// 2. edit Chairman Information
						 Thread.sleep(500);
 							...
 							Thread.sleep(500);
	 		    				...
	 		    				driver.findElement(SelectorExternal.finance_contact_email).sendKeys("GeorgeXulecu"+rand_int1+"@emailtest.com");	 		    			
