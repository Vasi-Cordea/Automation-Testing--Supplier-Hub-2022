	...
	public static void main (String args[]) throws InterruptedException{
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.id("i0116")));
				...
				Thread.sleep(500);
						...
						//TYPE INVITER NAME
						driver.findElement(Selectors.inviterName).sendKeys("Bobby Selenium");
						...
						driver.findElement(Selectors.CompanyName).sendKeys(rand_int1+" Bobby Ski LTD") ;
						...
						wait.until(ExpectedConditions.elementToBeClickable(Selectors.search_get));
						 ...
						 driver.findElement(Selectors.Approve_Confirm).click();
					        ...
					        JOptionPane.showMessageDialog(jFrame, "Invite/approval for * " +rand_int1+ " Bobby Ski LTD * in UAT done !");
