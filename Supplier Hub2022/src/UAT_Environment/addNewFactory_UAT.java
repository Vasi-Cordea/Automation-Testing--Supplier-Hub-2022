...
public class addNewFactory_UAT {

	@Test
	public void addFactoryUAT() {
        ...
        driver.manage().window().setSize(d);
	 	...
	 	wait.until(ExpectedConditions.elementToBeClickable(SelectorExternal.SignIn));
	 			...
	 			//type email 
	 			driver.findElement(SelectorExternal.username).sendKeys("qualitynow2022+uat+8112@emailtest.com");
...
//add another factory
		...
		//  Who is your main contact for this factory?
					...
					//generate random integer telephone number
					int rand_int9 = rand.nextInt(100000000);
					
					//type random telephone number in text-box
						driver.findElement(SelectorExternal.contact_phone_number).sendKeys("07"+rand_int9);
...
//			 What is the factory address?					
		...
		//Capability and Capacity Information
					...
					int rand_int10 = rand.nextInt(100);
					driver.findElement(SelectorExternal.z_total_capacity).sendKeys(rand_int10+"1");
					int rand_int11 = rand.nextInt(100);
					driver.findElement(SelectorExternal.z_testEnvironment_capacity).sendKeys(rand_int11+"4");
					int rand_int12 = rand.nextInt(1000);
					driver.findElement(SelectorExternal.z_planned_order_capacity).sendKeys(rand_int12+"5");
					int rand_int13 = rand.nextInt(10);
					driver.findElement(SelectorExternal.z_percentage_business).sendKeys(rand_int13+"6");
					int rand_int14 = rand.nextInt(10000);
					driver.findElement(SelectorExternal.z_estimated_vol_year_1).sendKeys(rand_int14+"7");
					int rand_int15 = rand.nextInt(100000);
					driver.findElement(SelectorExternal.z_estimated_vol_year_2).sendKeys(rand_int15+"8");
