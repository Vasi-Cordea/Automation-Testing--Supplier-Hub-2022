...
public class Onboarding_Externa_UAT {

	@Test
	public void onbUAT() throws InterruptedException {
...
//           Setup Company details	 			
 	 			...
 	 			driver.findElement(SelectorExternal.addressline1).sendKeys(generatedString+" King Street"); 
 	 			driver.findElement(SelectorExternal.addressline2).sendKeys(generatedString+" Boulevard"); 
 	 			driver.findElement(SelectorExternal.city).sendKeys("DetroiT"+generatedString); 
 	 			driver.findElement(SelectorExternal.county).sendKeys("New YorK"+generatedString); 
 	 			...
 	 			driver.findElement(SelectorExternal.headcount).sendKeys("16"); 
 	 			driver.findElement(SelectorExternal.female_count).sendKeys("11"); 
 	 			driver.findElement(SelectorExternal.male_count).sendKeys("5"); 
 	 			
 	 			driver.findElement(SelectorExternal.capability).click();
 	 			
 	 			driver.findElement(SelectorExternal.factory_count).sendKeys("140"); 
 	 			driver.findElement(SelectorExternal.min_order_quantityt).sendKeys("78"); 
 	 			driver.findElement(SelectorExternal.leadtime).sendKeys("60"); 
...
//           Who is your main contact for this factory?
 	 			...
 	 			driver.findElement(SelectorExternal.contact_first_name).sendKeys("FirstName"+generatedString);
 	 			...
 	 			//generate random integer telephone number
 					...
 					//type random telephone number in text-box
  					...
  					driver.findElement(SelectorExternal.contact_job_title).sendKeys("Test Lead "+generatedString);
//              Who is responsible for ethical compliance at this factory?
  					...
  					driver.findElement(SelectorExternal.compliance_contact_job_title).sendKeys("Test job "+generatedString);
...
//               Who is responsible for product compliance at this factory?
  					...
  					driver.findElement(SelectorExternal.product_compliance_contact_job_title).sendKeys("PO "+generatedString);
...
// 			 What is the factory address?					
  					...
  					driver.findElement(SelectorExternal.factory_city).sendKeys("cityName"+generatedString);
  					driver.findElement(SelectorExternal.factory_county).sendKeys("countyName"+generatedString);
     	 ...
     	 //eDIT Financial iNFORMATION
     			...
     			wait.until(ExpectedConditions.elementToBeClickable(SelectorExternal.financialInfoEdit));
 		 		...
 		 		// Generate random integers in range 0 to 999
 					...
 					driver.findElement(SelectorExternal.bank_name).sendKeys("Azusa Bank");
 					driver.findElement(SelectorExternal.branch_address_line_1).sendKeys("Independence "+generatedString);
 					driver.findElement(SelectorExternal.branch_address_line_2).sendKeys("Lotus"+rand_int9);
 					driver.findElement(SelectorExternal.branch_address_city).sendKeys("Porta Ventura "+generatedString);
 					...
 					driver.findElement(SelectorExternal.branch_address_postcode).sendKeys("234589");
 					
 			
 					
 					int rand_int41 = rand.nextInt(10);
 					driver.findElement(SelectorExternal.bic_swift_code).sendKeys(rand_int41+"8929544");
 					
 					int rand_int32 = rand.nextInt(10);
 					driver.findElement(SelectorExternal.bank_account_number).sendKeys("2723455"+rand_int32);
 					
 					driver.findElement(SelectorExternal.beneficiary_name).sendKeys("BeneficiarY" +generatedString);
