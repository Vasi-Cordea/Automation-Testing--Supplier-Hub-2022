...
public class Approvals_Suite_4 {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.id("i0116")));
				...
				Thread.sleep(300);
						...
						driver.findElement(Selectors.factory_appFactory).click();
						 ...
						 wait.until(ExpectedConditions.elementToBeClickable(Selectors.factory_makeReltionActivePopup));
							...
							Thread.sleep(1200);
							 ...
							 wait.until(ExpectedConditions.elementToBeClickable(Selectors.Supplier_searchText));
						        ...
						        JOptionPane.showMessageDialog(jFrame, " All approvals for  " +str+ " Timbaland  in SIT done succesfully!");
						...
						public void sourcingApp() throws InterruptedException {
							...
							// navigate to testing page
							driver.get("https://int-supplier-portal.aaaaa.com");
