	...
	public void addFactory_SIT() {
        ...
        driver.manage().window().setSize(d);
	 	...
	 	wait.until(ExpectedConditions.elementToBeClickable(SelectorExternal.SignIn));
	 			...
	 			//type email 
	 			driver.findElement(SelectorExternal.username).sendKeys("qualitynow2022+sit+2763@emailtest.com");
...
//         What is the full registered name of the factory?
	 		   // create instance of Random class
	 			...
	 			driver.findElement(SelectorExternal.registered_factory_name).sendKeys(rand_int1+" Supplier Registered Company Name");
...
//			 What is the factory address?					
 					...
 					driver.findElement(SelectorExternal.factory_city).sendKeys("");
 					...
 					driver.findElement(SelectorExternal.factory_postcode).sendKeys(rand_int1+"4");
 					driver.findElement(SelectorExternal.factory_head_count).sendKeys("100");
 					driver.findElement(SelectorExternal.factory_female_count).sendKeys("70");
 					driver.findElement(SelectorExternal.factory_male_count).sendKeys("30");
