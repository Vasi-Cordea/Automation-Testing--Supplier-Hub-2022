...
public class Onboarding_External_SIT {

	@Test
	public void OnboardSit() throws InterruptedException {
        ...
        driver.manage().window().setSize(d);
	 	...
	 	wait.until(ExpectedConditions.elementToBeClickable(SelectorExternal.SignIn));
	 			...
	 			//type email 
	 			driver.findElement(SelectorExternal.username).sendKeys("qualitynow2022+sit+5117@emailtest.com");
	 				
	 			driver.findElement(SelectorExternal.passwrord).sendKeys("yjT6T5Anr?"); 			
...
//          Setup Company details	 			
	 			...
	 			driver.findElement(SelectorExternal.county).sendKeys("Washington DC"); 
	 			...
	 			driver.findElement(SelectorExternal.headcount).sendKeys("48"); 
	 			driver.findElement(SelectorExternal.female_count).sendKeys("40"); 
	 			driver.findElement(SelectorExternal.male_count).sendKeys("8"); 
...
//          Who is your main contact for this factory?
	 			...
	 			driver.findElement(SelectorExternal.contact_first_name).sendKeys("Armando");
	 			
	 			driver.findElement(SelectorExternal.contact_surname).sendKeys("Calabrese");
...
//			 What is the factory address?					
 					...
 					driver.findElement(SelectorExternal.factory_city).sendKeys("Wembley");
 					...
 					driver.findElement(SelectorExternal.factory_head_count).sendKeys("140");
 					driver.findElement(SelectorExternal.factory_female_count).sendKeys("60");
 					driver.findElement(SelectorExternal.factory_male_count).sendKeys("80");
...
//   				//  Production Information
	  ...
	  // edit 1. Contact Information for Account/ Buying	
							 ...
							 driver.findElement(SelectorExternal.first_name).sendKeys("David");
							 driver.findElement(SelectorExternal.last_name).sendKeys("Livingstone");
						...
						// 2. edit Chairman Information
							// Thread.sleep(500);
	 							...
	 							//Thread.sleep(500);
		 		    				...
		 		    				driver.findElement(SelectorExternal.finance_last_name).sendKeys("Jungle");	 		    				
